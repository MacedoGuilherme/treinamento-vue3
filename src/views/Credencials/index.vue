<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <div
        class="flex py-3 pl-5 pr-20 mt-2 rounded items-center bg-brand-gray w-1/2"
      >
      ...
      >
        <pre>&lt;script src="https://MacedoGuilherme-feedbacker-widget.netlify.app?apikey={{ store.User.currentUser.apiKey }}"&gt;&lt;/script&gt;</pre>
      </div>
    </div>
  </div>
</template>
